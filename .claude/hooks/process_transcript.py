...
def read_and_process_raw_transcript(transcript_path):
    ...
    all_messages = list(assistant_messages.values()) + list(user_messages.values())
...
def main():
    try:
        ...
        if mode == "incremental":
            ...
            # Track what we've already logged (assistant by msg_id, user by uuid)
            ...
            summary = {
                ...
                "summary_data": {
                    ...
                    "validation": {
                        "complete": True,
                        "unique_messages_processed": len(messages)
                    }
                }
            }
            ...
            print(f"[OK] Generated session summary: {len(messages)} messages, {assistant_count} assistant, {user_prompts} user prompts")
